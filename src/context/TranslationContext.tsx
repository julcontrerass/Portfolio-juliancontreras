...
const translations: Translations = {
  es: {
    ...
    'experience.tukicode.description': 'Software Studio co-fundado junto a dos compañeros más de la facultad, especializado en el desarrollo de proyectos personalizados para diversos clientes.',
    ...
    'projects.tuki.title': 'Tuki - Tu Asistente De Salón',
    'projects.tuki.desc1': 'Sistema de gestión de mesas para restaurantes y cafeterías desarrollado en equipo de 3 personas como proyecto académico de la UTN.',
    'projects.tuki.desc2': 'Características principales:',
    'projects.tuki.desc3': '• Gestión completa de mesas y estados (disponible, ocupada, reservada)\n• Sistema de ventas en mesa y mostrador\n• Control de stock de productos e ingredientes\n• Gestión de caja con apertura y cierre de turnos\n• Panel administrativo completo\n• Reportes de ventas y estadísticas\n• Base de datos SQL Server con arquitectura en capas\n• Interfaz intuitiva y fácil de usar',
  ...
  en: {
    ...
    'projects.tuki.title': 'Tuki - Your Dining Room Assistant',
    'projects.tuki.desc1': 'Table management system for restaurants and cafeterias developed in a team of 3 as an academic project at UTN.',
    'projects.tuki.desc2': 'Main features:',
    'projects.tuki.desc3': '• Complete table management with status tracking (available, occupied, reserved)\n• Point of sale system for table and counter sales\n• Product and ingredient stock control\n• Cash register management with shift opening and closing\n• Complete administrative panel\n• Sales reports and statistics\n• SQL Server database with layered architecture\n• Intuitive and user-friendly interface',
    'projects.promoweb.title': 'Promo WEB',
